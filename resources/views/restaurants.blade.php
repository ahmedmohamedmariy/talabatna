		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6" data-aos="fade-up"  data-aos-delay="300" data-aos-duration="400">
				<div class="restaurants-girl-img food-photo-section">
					<img alt="man" src="{{url('frontend/img/photo-11.png')}}">
...
<div class="container">
<div class="banner-img" style="background-image: url({{url('frontend/img/food-4.jpg')}});">
...
<div class="row">
	...
	<div class="col-lg-6" data-aos="flip-up"  data-aos-delay="500" data-aos-duration="600">
		<div class="logos-card restaurant-page two">
			<img alt="logo" src="{{url('frontend/img/logos-4.jpg')}}">
				<div class="cafa">
	...
	<div class="col-lg-6" data-aos="flip-up"  data-aos-delay="200" data-aos-duration="300">
		<div class="logos-card restaurant-page two">
			<img alt="logo" src="{{url('frontend/img/logos-5.jpg')}}">
				<div class="cafa">
	...
	<div class="col-lg-6" data-aos="flip-up"  data-aos-delay="300" data-aos-duration="400">
		<div class="logos-card restaurant-page two">
			<img alt="logo" src="{{url('frontend/img/logos-6.jpg')}}">
				<div class="cafa">
