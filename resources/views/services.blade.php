...
@endsection
 ...
 <!-- hero-section -->
 <section class="hero-section about gap" style="background-image: url({{url('frontend/img/background.png')}});">
	<div class="container">
					...
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-6 col-sm-6 col-6">
							<div class="counter-img">
								<img alt="man" src="{{url('frontend/img/man-1.jpg')}}')}}">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-6">
		...
		<div class="row ">
			...
			<div class="col-lg-4" data-aos="flip-up"  data-aos-delay="300" data-aos-duration="400"
				...
				<div class="work-card service">
					...
					<h4>Select menu</h4>
					<p>Eu mi bibendum neque egestas congue quisque. Nulla facilisi morbi tempus iaculis lectus urna id volutpat lacus. Odio ut sem nulla </p>
				</div>
			</div>
		...
		<div class="row align-items-center">
			<div class="col-xl-6 col-lg-12" data-aos="flip-up"  data-aos-delay="200" data-aos-duration="300">
				<div class="sit-at-img">
					<img alt="man" src="{{url('frontend/img/man-3.jpg')}}')}}">
					<div class="counter-img-data">
								<h2>976</h2>
