...
<head>
  ...
  <title>Talabatna - @yield('title')</title>
  <link rel="icon" href="{{url('frontend/img/fav-icon.png')}}">
	<!-- CSS only -->
...
<body class="menu-layer">
			...
			<div class="row align-items-center">
				<div class="col-xl-2">
					<div class="header-style">
						<a href="index.html">
							<svg xmlns="http://www.w3.org/2000/svg" width="170" height="38" viewBox="0 0 163 38">
  <g id="Logo" transform="translate(-260 -51)">
    ...
    <text id="Quickeat" transform="translate(320 77)" fill="#363636" font-size="20" font-family="Poppins" font-weight="700"><tspan x="0" y="0">Talab</tspan><tspan y="0" fill="#f29f05">atna</tspan></text>
  </g>
</svg>
				      ...
				      <ul class="navbar-links">
				        ...
				        <li class="navbar-dropdown">
				          ...
				          <div class="dropdown">
				            ...
				            <a href="{{url('/restaurant-card')}}">Restaurant Card</a>
...
@yield('body')
  ...
  <g id="Logo" transform="translate(-260 -51)">
    ...
    <text id="Quickeat" transform="translate(320 77)" fill="#fff" font-size="20" font-family="Poppins" font-weight="700"><tspan x="0" y="0">Talab</tspan><tspan y="0" fill="#f29f05">atna</tspan></text>
  </g>
</svg>
						</a>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="menu">
						...
						<ul class="footer-menu">
							<li><a href="{{url('/')}}">home<i class="fa-solid fa-arrow-right"></i></a></li>
							<li><a href="{{url('/about')}}">about us<i class="fa-solid fa-arrow-right"></i></a></li>
							<li><a href="{{url('/restaurants')}}">Restaurants<i class="fa-solid fa-arrow-right"></i></a></li>
							<li><a href="{{url('/contacts')}}">Contacts<i class="fa-solid fa-arrow-right"></i></a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="menu contacts">
						...
						<a href="mailto:info@talabatna.com"><i class="fa-solid fa-envelope"></i>info@talabatna.com</a>
						<a href="callto:+14253261627"><i class="fa-solid fa-phone"></i>0123456789</a>
					</div>
			...
			<div class="footer-two gap no-bottom">
				<p>Copyright © 2024. Talabatna. All rights reserved.</p>
				<div class="privacy">
